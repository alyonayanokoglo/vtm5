...
const BLOOD_POTENCY_NOTES = {
  1: `• Прилив Крови: разово добавь +2d10 к любой физической, ментальной или социальной проверке.
• Заживление: можешь избавиться от 1 лёгкого повреждения за каждое испытание Крови, которое готов пройти.
• Дисциплины: если после использования Дисциплины 1-го уровня тебе нужно пройти испытание Крови, брось две игральные кости и выбери лучший результат — если успех, Голод не поднимается.
• Клановый изъян: тяжесть твоего изъяна равна 1.`,
  2: `• Прилив Крови: Разово добавь +2d10 к любой физической, ментальной или социальной проверке.
• Заживление: Можешь избавиться от 2 лёгких повреждений за каждое испытание Крови, которое готов пройти.
• Дисциплины: Используя Дисциплины 1-го уровня, если нужно пройти испытание Крови — брось две игральные кости и выбери лучший результат; успех — Голод не поднимается.
• Клановый изъян: Тяжесть твоего изъяна равна 2.
• Питание: Животная и донорская кровь насыщают хуже.`,
  3: `• Прилив Крови: Разово добавь +2d10 к любой физической, ментальной или социальной проверке.
• Заживление: Можешь избавиться от 2 лёгких повреждений за каждое испытание Крови, которое готов пройти.
• Дисциплины: Используя Дисциплины 2-го уровня и ниже, если нужно пройти испытание Крови — брось две игральные кости и выбери лучший результат; успех — Голод не поднимается.
• Клановый изъян: Тяжесть твоего изъяна равна 2.
• Питание: Животная и донорская кровь не насыщают.`,
  4: `• Прилив Крови: Разово добавь +3d10 к любой физической, ментальной или социальной проверке.
• Заживление: Можешь избавиться от 3 лёгких повреждений за каждое испытание Крови, которое готов пройти.
• Дисциплины: Используя Дисциплины 2-го уровня и ниже, если нужно пройти испытание Крови — брось две игральные кости и выбери лучший результат; успех — Голод не поднимается.
• Клановый изъян: Тяжесть твоего изъяна равна 3.
• Питание: Только человеческая кровь насыщает, и то хуже обычного.`,
  5: `• Прилив Крови: Разово добавь +4d10 к любой физической, ментальной или социальной проверке.
• Заживление: Можешь избавиться от 3 лёгких повреждений за каждое испытание Крови, которое готов пройти.
• Дисциплины: Используя Дисциплины 3-го уровня и ниже, если нужно пройти испытание Крови — брось две игральные кости и выбери лучший результат; успех — Голод не поднимается.
• Клановый изъян: Тяжесть твоего изъяна равна 3.
• Питание: Чтобы снизить Голод ниже 2, нужно убить жертву.`,
  6: `• Прилив Крови: Разово добавь +4d10 к любой физической, ментальной или социальной проверке.
• Заживление: Можешь избавиться от 3 лёгких повреждений за каждое испытание Крови, которое готов пройти.
• Дисциплины: Используя Дисциплины 3-го уровня и ниже, если нужно пройти испытание Крови — брось две игральные кости и выбери лучший результат; успех — Голод не поднимается.
• Клановый изъян: Тяжесть твоего изъяна равна 4.
• Питание: Кровь насыщает очень плохо, нужен смертельный исход.`,
  7: `• Прилив Крови: Разово добавь +5d10 к любой физической, ментальной или социальной проверке.
• Заживление: Можешь избавиться от 4 лёгких повреждений за каждое испытание Крови, которое готов пройти.
• Дисциплины: Используя Дисциплины 4-го уровня и ниже, если нужно пройти испытание Крови — брось две игральные кости и выбери лучший результат; успех — Голод не поднимается.
• Клановый изъян: Тяжесть твоего изъяна равна 5.
• Питание: Насытиться практически невозможно без убийств.`,
  8: `• Прилив Крови: Разово добавь +5d10 к любой физической, ментальной или социальной проверке.
• Заживление: Можешь избавиться от 4 лёгких повреждений за каждое испытание Крови, которое готов пройти.
• Дисциплины: Используя Дисциплины 4-го уровня и ниже, если нужно пройти испытание Крови — брось две игральные кости и выбери лучший результат; успех — Голод не поднимается.
• Клановый изъян: Тяжесть твоего изъяна равна 5.
• Питание: Чтобы опускать Голод ниже 3, обычно требуется смертельное кормление; обычная добыча почти не поддерживает.`,
  9: `• Прилив Крови: Разово добавь +6d10 к любой физической, ментальной или социальной проверке.
• Заживление: Можешь избавиться от 4 лёгких повреждений за каждое испытание Крови, которое готов пройти.
• Дисциплины: Используя Дисциплины 5-го уровня и ниже, если нужно пройти испытание Крови — брось две игральные кости и выбери лучший результат; успех — Голод не поднимается.
• Клановый изъян: Тяжесть твоего изъяна равна 6.
• Питание: Питание крайне затруднено, а слабости клана становятся доминирующим фактором поведения и выживания.`,
  10: `• Прилив Крови: Разово добавь +6d10 к любой физической, ментальной или социальной проверке.
• Заживление: Можешь избавиться от 5 лёгких повреждений за каждое испытание Крови, которое готов пройти.
• Дисциплины: Используя Дисциплины 5-го уровня и ниже, если нужно пройти испытание Крови — брось две игральные кости и выбери лучший результат; успех — Голод не поднимается.
• Клановый изъян: Тяжесть твоего изъяна равна 6.
• Питание: Это уровень почти нечеловеческой сущности: мощь огромна, но цена в виде проклятий и требований к кормлению максимальна.`,
}
...
function renderBloodPotencyNote(text) {
  const lines = (text || '')
    .replace(/\r\n/g, '\n')
    .split('\n')
    .map((line) => line.trim())
  ...
  return (
    <ul className="blood-note-list">
      {lines.map((line, index) => {
        const normalized = line.startsWith('•') ? line.slice(1).trim() : line
        const colonIndex = normalized.indexOf(':')

        if (colonIndex === -1) {
          return <li key={`blood-note-line-${index}`}>{normalized}</li>
        }

        const title = normalized.slice(0, colonIndex + 1).trim()
        const body = normalized.slice(colonIndex + 1).trim()
        return (
          <li key={`blood-note-line-${index}`}>
            <strong>{title}</strong>{' '}
            {body}
          </li>
        )
...
function App() {
      ...
      {Array.from({ length: total }).map((_, i) => (
        ...
        >
          {shape === 'square'
            ...
            : shape === 'blood-drop'
              ? <path className="dot-ring" d="M50 6C35 28 16 45 16 63C16 82 31 94 50 94C69 94 84 82 84 63C84 45 65 28 50 6Z" />
          ...
          {(mode === 'disabled-after-limit' ? i >= filled : i < filled)
            ? (shape === 'square'
              ...
              : shape === 'blood-drop'
                ? <path className="dot-core" d="M50 20C39 37 26 49 26 63C26 76 36 84 50 84C64 84 74 76 74 63C74 49 61 37 50 20Z" />
  ...
  const loadCharacterJson = async (event) => {
    ...
    try {
      ...
      setSkills((prev) => {
        const nextSkills = { ...prev, ...parsed.skills }
        if (
          Number.isFinite(parsed.skills?.Принципы) &&
          !Number.isFinite(parsed.skills?.Убеждение)
        ) {
          nextSkills.Убеждение = parsed.skills.Принципы
        }
        return nextSkills
      })
      setSkillNotes((prev) => {
        const nextSkillNotes = { ...prev, ...initialSkillNotes, ...(parsed.skillNotes || {}) }
        if (
          typeof parsed.skillNotes?.Принципы === 'string' &&
          !(typeof parsed.skillNotes?.Убеждение === 'string' && parsed.skillNotes.Убеждение.trim())
        ) {
          nextSkillNotes.Убеждение = parsed.skillNotes.Принципы
        }
        return nextSkillNotes
      })
      setDisciplines(
    ...
    <main className="sheet" ref={sheetRef}>
      ...
      <section className="panel grid2">
        ...
        <label>
          ...
          <textarea
            className="blood-potency-note-input"
            rows={2}
          ...
          <div className="print-block">
            ...
            <div className="print-top">
              ...
              <div className="print-top-col">
                ...
                <div><strong>Убеждение:</strong> {character.convictions || '____________________'}</div>
          ...
          <div className="print-grid2-full print-status-blood-grid">
            <div className="print-block">
              ...
              <div className="print-card">
                <div className="print-row"><span>Голод</span>{renderTrack(character.hunger, 5, 'filled', 'blood-drop')}</div>
            ...
            <div className="print-block">
              ...
              <div className="print-card">
                ...
                <div className="print-row-note print-blood-note">
                  {character.bloodPotencyNote?.trim() ? renderBloodPotencyNote(character.bloodPotencyNote) : ''}
                </div>
              </div>
            </div>
          </div>
